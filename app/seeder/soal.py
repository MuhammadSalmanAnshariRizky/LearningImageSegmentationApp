    ...
    data = [
        ...
        },
        {
            "question": {
                        "text": """
                        <p>
                        Diketahui sebuah citra RGB berukuran 2×2 piksel dengan nilai sebagai berikut:
                        </p>
                        ...
                        <p>
                        Jika dilakukan konversi ke grayscale menggunakan metode rata-rata:
                        </p>
                        ...
                        <p>
                        Maka nilai grayscale pada f(1,0) adalah …
                        </p>
                        """,
                        "URL": None
                    },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam segmentasi citra, setiap wilayah \\( R_i \\) harus merupakan 
                <i>connected set</i>.
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam segmentasi citra, predikat \\( Q(R_i) \\) digunakan sebagai kriteria homogenitas.
                </p>
            ...
            "question": {
                "text": """
                <p>
                Pendekatan <i>edge-based segmentation</i> digunakan dengan cara…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Pada kondisi citra yang memiliki banyak tekstur dan perubahan intensitas kecil, 
                metode yang lebih tepat digunakan adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Perbedaan utama antara <i>edge-based</i> dan <i>region-based segmentation</i> adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam <i>region-based segmentation</i>, penggunaan standar deviasi bertujuan untuk…
                </p>
                """,
                "URL": None
            },
            ...
            "question": {
                "text": """
                <p>
                Konsep utama dari <i>edge-based segmentation</i> adalah….
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Peran utama tepi (<i>edge</i>) dalam segmentasi citra adalah….
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                <i>Edge chain</i> tertutup dalam segmentasi citra berfungsi untuk….
                </p>
                """,
                "URL": None
            },
            ...
            "question": {
                "text": """
                <p>
                Pada proses <i>edge image thresholding</i>, tujuan utama penggunaan threshold adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Pada algoritma <i>Non-Maximal Suppression</i>, suatu piksel akan dihapus jika…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Jika suatu piksel memiliki arah gradien sebesar \\( 90^\\circ \\), maka piksel tersebut dibandingkan dengan…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                ...
                <p>
                Sebuah piksel memiliki nilai 50 dan tidak terhubung dengan piksel tepi kuat. 
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam algoritma <i>inner boundary tracing</i>, cara menentukan piksel awal 
                \\( P_0 \\) adalah ....
                </p>
                """,
                "URL": None
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Pada pencarian tetangga menggunakan <i>8-connectivity</i>, arah pencarian dilakukan dengan cara ....
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Kondisi berhenti (<i>stopping condition</i>) pada <i>inner boundary tracing</i> terjadi ketika ....
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam <i>extended boundary</i>, perlakuan terhadap piksel <b>RIGHT</b> adalah ....
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                <i>Graylevel Thresholding</i> digunakan untuk memisahkan objek dan latar belakang pada citra 
                berdasarkan nilai intensitas piksel dengan bantuan nilai ambang (<i>threshold</i>).
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Jika suatu piksel memiliki nilai intensitas lebih besar dari threshold \\( T \\), 
                maka pada citra biner hasil thresholding piksel tersebut akan bernilai…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Metode thresholding sederhana banyak digunakan karena memiliki kelebihan utama yaitu…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Jika nilai threshold \\( T = 150 \\), maka piksel dengan nilai intensitas 
                kurang dari atau sama dengan 150 akan diklasifikasikan sebagai…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam proses segmentasi citra, terdapat metode yang menggunakan satu nilai 
                <i>threshold</i> untuk seluruh piksel pada citra tanpa membedakan posisi atau area tertentu.
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Pada beberapa citra, pencahayaan tidak merata sehingga penggunaan satu nilai 
                <i>threshold</i> tidak cukup baik.
                </p>

                <p>
                Oleh karena itu digunakan metode yang menentukan nilai threshold berdasarkan bagian tertentu dari citra.
                Metode ini disebut…
                </p>
                """,
                "URL": None
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Suatu metode thresholding memilih piksel sebagai objek jika nilainya berada dalam suatu 
                rentang intensitas tertentu, bukan hanya berdasarkan satu nilai ambang.
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam segmentasi citra, terdapat metode yang membagi piksel ke dalam beberapa kelas 
                berdasarkan beberapa rentang nilai intensitas, sehingga tidak hanya menghasilkan dua kelas saja.
                </p>
        ...
        },
         {
            "question": {
                "text": """
                <p>
                Dalam menentukan nilai threshold menggunakan metode <i>p-tile</i>, diperlukan informasi awal 
                mengenai proporsi objek terhadap keseluruhan citra.
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Histogram citra sering digunakan untuk membantu menentukan nilai threshold. 
                Jika histogram memiliki dua puncak yang jelas (<i>bimodal</i>), maka nilai threshold 
                yang baik biasanya dipilih…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam beberapa kasus, bentuk histogram tidak jelas karena adanya piksel pada batas objek 
                dan <i>background</i>.
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Algoritma Otsu menentukan nilai threshold secara otomatis dengan memilih nilai yang 
                menghasilkan pemisahan terbaik antara objek dan <i>background</i>.
                </p>
            ...
            "question": {
                "text": """
                <p>
                Tujuan utama dari <i>region-based segmentation</i> adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Metode <i>region growing</i> lebih efektif digunakan pada citra yang memiliki noise karena…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Diketahui fungsi homogenitas \\( Q(R_i) \\).
                </p>

                <p>
                Pernyataan yang tepat untuk \\( Q(R_i) = TRUE \\) adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Diketahui dua region bertetangga \\( R_i \\) dan \\( R_j \\).
                </p>

                <p>
                Jika \\( Q(R_i \\cup R_j) = FALSE \\), maka…
                </p>
                """,
                "URL": None
            },
            ...
            "question": {
                "text": """
                <p>
                Pada metode <i>region merging</i>, kondisi berikut harus dipenuhi agar suatu region valid:
                </p>
                ...
                <p>
                Makna dari kondisi tersebut adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dua region \\( R_i \\) dan \\( R_j \\) dapat digabung jika memenuhi kriteria:
                </p>
                ...
                <p>
                Jika diketahui \\( \\mu_i = 20 \\) dan \\( \\mu_j = 24 \\), maka keputusan yang benar adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam proses <i>region merging</i>, penggabungan hanya dilakukan pada region yang…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Berdasarkan hasil validasi, jika semua pasangan region bertetangga memiliki:
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Pada metode <i>split and merge</i>, proses penggabungan (<i>merging</i>) antara dua region bertetangga 
                dapat dilakukan apabila memenuhi kondisi…
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam metode <i>split and merge</i>, apabila suatu region tidak memenuhi kriteria homogenitas, 
                maka tindakan yang dilakukan terhadap region tersebut adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam proses <i>merging</i>, empat region yang memiliki parent yang sama dapat digabungkan menjadi 
                satu region apabila memenuhi kondisi…
                </p>
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Struktur data yang digunakan untuk merepresentasikan hasil segmentasi pada metode 
                <i>split and merge</i> dalam bentuk pohon adalah…
                </p>
                """,
                "URL": None
            },
            ...
            "question": {
                "text": """
                <p>
                Pada tahap <i>post-processing</i> dalam segmentasi citra, tujuan utama dilakukan 
                perbaikan hasil segmentasi adalah untuk…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Pada metode <i>boundary elimination</i>, batas antar region akan dihilangkan berdasarkan…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Dalam algoritma <i>removal of small image regions</i>, langkah pertama yang dilakukan adalah…
                </p>
                """,
                "URL": None
            },
        ...
        },
        {
            "question": {
                "text": """
                <p>
                Proses penggabungan region kecil dilakukan secara berulang hingga kondisi berikut terpenuhi, yaitu…
                </p>
                """,
                "URL": None
            },
...
def seed_activity():
    ...
    db.session.commit()
    print("✅ Seeder activity berhasil (multi data)")
...
\\]
                ...
                <p>
                Maka nilai grayscale pada posisi f(2,2) adalah…
                </p>
                """,
                "URL": None
            },
...

        {
            "question": {
                ...
                <p>
                Jika threshold \\( t = 2 \\), maka jumlah piksel background adalah....
                </p>
                """,
                "URL": None
            },
...
def seed_kuis():
    ...
    Activity.query.filter_by(type="kuis").delete()
    db.session.commit()
