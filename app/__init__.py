...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://researc4_salman:MsalmanAr13@localhost/researc4_segmentasi?unix_socket=/var/lib/mysql/mysql.sock'
    ...
    def inject_sidebar():
        ...
        if not user_id or user_role != 'Student':
            return dict(aktif_materi=[], completed_materi=[])
        ...
        for a in activities:
            if a.id_topic and a.id_subtopic:
                aktif_materi.append((a.id_class, a.id_topic, a.id_subtopic))
        ...
        return dict(aktif_materi=aktif_materi, completed_materi=completed_materi)
